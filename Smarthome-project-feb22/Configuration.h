...
#define LED_THOLD 25 // set the lower led threshold if the output is lower than LED_THOLD it will output 0 instead, defaulted to 0
...
//Select LED Manual adjustment mode
...
// Whole Scope: CAP_W -- the adjustor move the entire upper cap and lower cap scope thus the ratio is not affected
...
#define LUMINANCE_EXPONENT 3 // exponent for the exponential growth
#define INIT_BRIGHTNESS 500 // initial brightness for LED to start operating
#define INIT_LUMINANCE 25 // initial power for LED to operate
#define END_BRIGHTNESS 1023 // final brightness for LED to operate at full power
#define END_LUMINANCE 255 // power output when operating at full
